...
urlpatterns = [
    path('', views.members_home, name='homepage'),
    path('public/', views.homepage, name='booking_homepage'),
    ...
    path('login/', auth_views.LoginView.as_view(template_name='bookings/login.html', next_page='/public/'), name='login'),
